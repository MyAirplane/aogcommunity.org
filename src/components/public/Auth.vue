<template>
  ...
  >
    ...
    >
      <p class="text-xl font-bold text-white leading-10">Join the Beta</p>
      <div>
        <p class="text-sm font-medium text-gray-200 leading-7">
          Sign in using social logins
        </p>
    ...
    <div v-if="store.user && !alert_msg" class="p-10 text-center space-y-4">
      <h2 class="text-2xl font-semibold text-white">
        👋 Hello,
        {{ store.profile.first_name ? store.profile.first_name : "aviator" }}!
      </h2>
      ...
      <router-link
        ...
        class="
          ...
          focus:outline-none
        "
        >Go to Dashboard &rarr;</router-link
      >
    </div>
    <div v-if="alert_msg" class="p-10 text-center">
